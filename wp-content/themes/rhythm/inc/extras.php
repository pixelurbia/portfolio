...
function ts_add_phone_to_menu( $items, $args ) {
	if( 'primary' === $args->theme_location ) {
		...
		if( ts_get_opt( 'header-enable-phone' ) && ! empty ( ts_get_opt( 'header-phone-number' ) ) ) {
			$items .= '<li class="nav-phone"><a href="tel:' . esc_attr( ts_get_opt( 'header-phone-number' ) ) . '"><i class="fa fa-phone"></i> ' . esc_html( ts_get_opt( 'header-phone-number' ) ) . '</a></li>';
		}
