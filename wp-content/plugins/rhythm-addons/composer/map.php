...
vc_map( array(
	...
	'params'        => array(
		...
		array(
			...
			'dependency'  => array( 'element' => 'style', 'value' => array('full_height_video_with_scroll', 'alt_full_height_video_with_scroll', 'banner_with_image_rotator', 'full_height_with_no_buttons', 'full_height_with_solid_buttons', 'full_height_with_solid_button', 'full_height', 'full_height_video', 'bigger_with_buttons', 'bigger_with_video', 'banner_with_text_rotator', 'banner_with_play_button', 'bigger_with_video_no_buttons') ),
		),
		array(
			'type'        => 'colorpicker',
